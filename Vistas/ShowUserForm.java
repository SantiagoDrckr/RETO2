...
public class ShowUserForm extends javax.swing.JDialog {
    ...
    public void recibeDatos(int idEmp, String NOMBREeMO, String apellidos, String tipoDocumento, String documento, String correo) {
        System.out.println("IdEmp: " + idEmp + ", nombre: " + NOMBREeMO + " " + apellidos
                + ". documento: " + tipoDocumento + " " + documento + ", correo: " + correo);
        txtId.setText("" + idEmp);
        txtNombre.setText(NOMBREeMO);
    ...
    public void ActualizarEmpleado() {
        ...
        if (NOMBREeMO.isEmpty()) {
            ...
            String query = " UPDATE empleados SET `NOMBREeMO`='" + NOMBREeMO + "',"
                    + "`apellidos`='" + apellidos + "',"
